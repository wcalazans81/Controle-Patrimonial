document.addEventListener("DOMContentLoaded", function () { 
    ...
    // === EVENTO BOTÃO "salvar_03" - Envia dados via fetch ===
    const btnSalvar00 = document.getElementById("salvar_03");
    if (btnSalvar00) {
        btnSalvar00.addEventListener("click", function (event) {
            event.preventDefault();

            let andar = document.querySelector("input[name='andar_03']").value.trim().toUpperCase();
            let patrimonio = document.querySelector("input[name='patrimonio_03']").value.trim().toUpperCase();
            let empresa = document.querySelector("input[name='empresa_03']").value.trim().toUpperCase();
            let nome = document.querySelector("input[name='nome_03']").value.trim().toUpperCase();
            let setor = document.querySelector("input[name='setor_03']").value.trim().toUpperCase();
            let descricao = document.querySelector("input[name='descricao_03']").value.trim().toUpperCase();
            let destino = document.querySelector("input[name='destino_03']:checked");
            ...
            let dados = {
                andar_03: andar,
                Npatrimonio_03: patrimonio,
                empresa_03: empresa,
                nome_03: nome,
                setor_03: setor,
                descricao_03: descricao,
                destino_03: destino
            };
    ...
    const btnMostrarBusca = document.getElementById("btnMostrarBusca_03");
    const campoBusca = document.getElementById("campoBusca_03");
    const btnBuscar = document.getElementById("btnBuscarPatrimonio_03");
    ...
    const btnSalvarPdf = document.getElementById("btnSalvarPdf_03");
    if (btnSalvarPdf) {
