document.addEventListener("DOMContentLoaded", function () { 
    ...
    // === EVENTO BOTÃO "salvar_09" - Envia dados via fetch ===
    const btnSalvar00 = document.getElementById("salvar_09");
    if (btnSalvar00) {
        btnSalvar00.addEventListener("click", function (event) {
            event.preventDefault();

            let andar = document.querySelector("input[name='andar_09']").value.trim().toUpperCase();
            let patrimonio = document.querySelector("input[name='patrimonio_09']").value.trim().toUpperCase();
            let empresa = document.querySelector("input[name='empresa_09']").value.trim().toUpperCase();
            let nome = document.querySelector("input[name='nome_09']").value.trim().toUpperCase();
            let setor = document.querySelector("input[name='setor_09']").value.trim().toUpperCase();
            let descricao = document.querySelector("input[name='descricao_09']").value.trim().toUpperCase();
            let destino = document.querySelector("input[name='destino_09']:checked");
            ...
            let dados = {
                andar_09: andar,
                Npatrimonio_09: patrimonio,
                empresa_09: empresa,
                nome_09: nome,
                setor_09: setor,
                descricao_09: descricao,
                destino_09: destino
            };
    ...
    const btnMostrarBusca = document.getElementById("btnMostrarBusca_09");
    const campoBusca = document.getElementById("campoBusca_09");
    const btnBuscar = document.getElementById("btnBuscarPatrimonio_09");
    ...
    const btnSalvarPdf = document.getElementById("btnSalvarPdf_09");
    if (btnSalvarPdf) {
