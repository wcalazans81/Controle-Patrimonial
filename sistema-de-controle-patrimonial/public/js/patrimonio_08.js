document.addEventListener("DOMContentLoaded", function () { 
    ...
    // === EVENTO BOTÃO "salvar_08" - Envia dados via fetch ===
    const btnSalvar00 = document.getElementById("salvar_08");
    if (btnSalvar00) {
        btnSalvar00.addEventListener("click", function (event) {
            event.preventDefault();

            let andar = document.querySelector("input[name='andar_08']").value.trim().toUpperCase();
            let patrimonio = document.querySelector("input[name='patrimonio_08']").value.trim().toUpperCase();
            let empresa = document.querySelector("input[name='empresa_08']").value.trim().toUpperCase();
            let nome = document.querySelector("input[name='nome_08']").value.trim().toUpperCase();
            let setor = document.querySelector("input[name='setor_08']").value.trim().toUpperCase();
            let descricao = document.querySelector("input[name='descricao_08']").value.trim().toUpperCase();
            let destino = document.querySelector("input[name='destino_08']:checked");
            ...
            let dados = {
                andar_08: andar,
                Npatrimonio_08: patrimonio,
                empresa_08: empresa,
                nome_08: nome,
                setor_08: setor,
                descricao_08: descricao,
                destino_08: destino
            };
    ...
    const btnMostrarBusca = document.getElementById("btnMostrarBusca_08");
    const campoBusca = document.getElementById("campoBusca_08");
    const btnBuscar = document.getElementById("btnBuscarPatrimonio_08");
    ...
    const btnSalvarPdf = document.getElementById("btnSalvarPdf_08");
    if (btnSalvarPdf) {
