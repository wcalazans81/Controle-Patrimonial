document.addEventListener("DOMContentLoaded", function () { 
    ...
    // === EVENTO BOTÃO "salvar_07" - Envia dados via fetch ===
    const btnSalvar00 = document.getElementById("salvar_07");
    if (btnSalvar00) {
        btnSalvar00.addEventListener("click", function (event) {
            event.preventDefault();

            let andar = document.querySelector("input[name='andar_07']").value.trim().toUpperCase();
            let patrimonio = document.querySelector("input[name='patrimonio_07']").value.trim().toUpperCase();
            let empresa = document.querySelector("input[name='empresa_07']").value.trim().toUpperCase();
            let nome = document.querySelector("input[name='nome_07']").value.trim().toUpperCase();
            let setor = document.querySelector("input[name='setor_07']").value.trim().toUpperCase();
            let descricao = document.querySelector("input[name='descricao_07']").value.trim().toUpperCase();
            let destino = document.querySelector("input[name='destino_07']:checked");
            ...
            let dados = {
                andar_07: andar,
                Npatrimonio_07: patrimonio,
                empresa_07: empresa,
                nome_07: nome,
                setor_07: setor,
                descricao_07: descricao,
                destino_07: destino
            };
    ...
    const btnMostrarBusca = document.getElementById("btnMostrarBusca_07");
    const campoBusca = document.getElementById("campoBusca_07");
    const btnBuscar = document.getElementById("btnBuscarPatrimonio_07");
    ...
    const btnSalvarPdf = document.getElementById("btnSalvarPdf_07");
    if (btnSalvarPdf) {
