document.addEventListener("DOMContentLoaded", function () { 
    ...
    // === EVENTO BOTÃO "salvar_06" - Envia dados via fetch ===
    const btnSalvar00 = document.getElementById("salvar_06");
    if (btnSalvar00) {
        btnSalvar00.addEventListener("click", function (event) {
            event.preventDefault();

            let andar = document.querySelector("input[name='andar_06']").value.trim().toUpperCase();
            let patrimonio = document.querySelector("input[name='patrimonio_06']").value.trim().toUpperCase();
            let empresa = document.querySelector("input[name='empresa_06']").value.trim().toUpperCase();
            let nome = document.querySelector("input[name='nome_06']").value.trim().toUpperCase();
            let setor = document.querySelector("input[name='setor_06']").value.trim().toUpperCase();
            let descricao = document.querySelector("input[name='descricao_06']").value.trim().toUpperCase();
            let destino = document.querySelector("input[name='destino_06']:checked");
            ...
            let dados = {
                andar_06: andar,
                Npatrimonio_06: patrimonio,
                empresa_06: empresa,
                nome_06: nome,
                setor_06: setor,
                descricao_06: descricao,
                destino_06: destino
            };
    ...
    const btnMostrarBusca = document.getElementById("btnMostrarBusca_06");
    const campoBusca = document.getElementById("campoBusca_06");
    const btnBuscar = document.getElementById("btnBuscarPatrimonio_06");
    ...
    const btnSalvarPdf = document.getElementById("btnSalvarPdf_06");
    if (btnSalvarPdf) {
