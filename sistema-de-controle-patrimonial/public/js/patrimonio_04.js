document.addEventListener("DOMContentLoaded", function () { 
    ...
    // === EVENTO BOTÃO "salvar_04" - Envia dados via fetch ===
    const btnSalvar00 = document.getElementById("salvar_04");
    if (btnSalvar00) {
        btnSalvar00.addEventListener("click", function (event) {
            event.preventDefault();

            let andar = document.querySelector("input[name='andar_04']").value.trim().toUpperCase();
            let patrimonio = document.querySelector("input[name='patrimonio_04']").value.trim().toUpperCase();
            let empresa = document.querySelector("input[name='empresa_04']").value.trim().toUpperCase();
            let nome = document.querySelector("input[name='nome_04']").value.trim().toUpperCase();
            let setor = document.querySelector("input[name='setor_04']").value.trim().toUpperCase();
            let descricao = document.querySelector("input[name='descricao_04']").value.trim().toUpperCase();
            let destino = document.querySelector("input[name='destino_04']:checked");
            ...
            let dados = {
                andar_04: andar,
                Npatrimonio_04: patrimonio,
                empresa_04: empresa,
                nome_04: nome,
                setor_04: setor,
                descricao_04: descricao,
                destino_04: destino
            };
    ...
    const btnMostrarBusca = document.getElementById("btnMostrarBusca_04");
    const campoBusca = document.getElementById("campoBusca_04");
    const btnBuscar = document.getElementById("btnBuscarPatrimonio_04");
    ...
    const btnSalvarPdf = document.getElementById("btnSalvarPdf_04");
    if (btnSalvarPdf) {
