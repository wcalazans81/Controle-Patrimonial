...
router.get('/patrimonioEditar_04/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_04 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_04', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_04/:id', (req, res) => { 
    const { andar_04, patrimonio_04, empresa_04, nome_04, setor_04, descricao_04, destino_04 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_04 
            SET andar_04 = ?, Npatrimonio_04 = ?, empresa_04 = ?, nome_04 = ?, 
                setor_04 = ?, data_04 = ?, descricao_04 = ?, destino_04 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_04, patrimonio_04, empresa_04, nome_04, setor_04, data, descricao_04, destino_04, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_04 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_04], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_04, empresa_04, nome_04, setor_04, data, descricao_04, destino_04, patrimonio_04], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_04, andar_04, empresa_04, nome_04, setor_04, data, descricao_04, destino_04], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
