...
router.get('/patrimonioEditar_05/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_05 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_05', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_05/:id', (req, res) => { 
    const { andar_05, patrimonio_05, empresa_05, nome_05, setor_05, descricao_05, destino_05 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_05 
            SET andar_05 = ?, Npatrimonio_05 = ?, empresa_05 = ?, nome_05 = ?, 
                setor_05 = ?, data_05 = ?, descricao_05 = ?, destino_05 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_05, patrimonio_05, empresa_05, nome_05, setor_05, data, descricao_05, destino_05, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_05 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_05], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_05, empresa_05, nome_05, setor_05, data, descricao_05, destino_05, patrimonio_05], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_05, andar_05, empresa_05, nome_05, setor_05, data, descricao_05, destino_05], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
