...
router.get('/patrimonioEditar_07/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_07 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_07', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_07/:id', (req, res) => { 
    const { andar_07, patrimonio_07, empresa_07, nome_07, setor_07, descricao_07, destino_07 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_07 
            SET andar_07 = ?, Npatrimonio_07 = ?, empresa_07 = ?, nome_07 = ?, 
                setor_07 = ?, data_07 = ?, descricao_07 = ?, destino_07 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_07, patrimonio_07, empresa_07, nome_07, setor_07, data, descricao_07, destino_07, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_07 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_07], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_07, empresa_07, nome_07, setor_07, data, descricao_07, destino_07, patrimonio_07], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_07, andar_07, empresa_07, nome_07, setor_07, data, descricao_07, destino_07], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
