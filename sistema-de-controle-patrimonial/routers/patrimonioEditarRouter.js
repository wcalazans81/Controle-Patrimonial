...
router.get('/patrimonioEditar/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_00 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar/:id', (req, res) => {
    const { andar_00, patrimonio_00, empresa_00, nome_00, setor_00, descricao_00, destino_00 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_00 
            SET andar_00 = ?, Npatrimonio_00 = ?, empresa_00 = ?, nome_00 = ?, 
                setor_00 = ?, data_00 = ?, descricao_00 = ?, destino_00 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_00, patrimonio_00, empresa_00, nome_00, setor_00, data, descricao_00, destino_00, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_00 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_00], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_00, empresa_00, nome_00, setor_00, data, descricao_00, destino_00, patrimonio_00], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_00, andar_00, empresa_00, nome_00, setor_00, data, descricao_00, destino_00], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
