...
router.get('/patrimonioEditar_01/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_01 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_01', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_01/:id', (req, res) => { 
    const { andar_01, patrimonio_01, empresa_01, nome_01, setor_01, descricao_01, destino_01 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_01 
            SET andar_01 = ?, Npatrimonio_01 = ?, empresa_01 = ?, nome_01 = ?, 
                setor_01 = ?, data_01 = ?, descricao_01 = ?, destino_01 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_01, patrimonio_01, empresa_01, nome_01, setor_01, data, descricao_01, destino_01, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_01 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_01], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_01, empresa_01, nome_01, setor_01, data, descricao_01, destino_01, patrimonio_01], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_01, andar_01, empresa_01, nome_01, setor_01, data, descricao_01, destino_01], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
