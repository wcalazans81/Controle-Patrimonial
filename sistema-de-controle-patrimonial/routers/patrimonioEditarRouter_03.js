...
router.get('/patrimonioEditar_03/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_03 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_03', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_03/:id', (req, res) => { 
    const { andar_03, patrimonio_03, empresa_03, nome_03, setor_03, descricao_03, destino_03 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_03 
            SET andar_03 = ?, Npatrimonio_03 = ?, empresa_03 = ?, nome_03 = ?, 
                setor_03 = ?, data_03 = ?, descricao_03 = ?, destino_03 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_03, patrimonio_03, empresa_03, nome_03, setor_03, data, descricao_03, destino_03, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_03 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_03], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_03, empresa_03, nome_03, setor_03, data, descricao_03, destino_03, patrimonio_03], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_03, andar_03, empresa_03, nome_03, setor_03, data, descricao_03, destino_03], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
