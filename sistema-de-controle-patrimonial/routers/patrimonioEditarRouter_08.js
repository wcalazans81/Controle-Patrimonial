...
router.get('/patrimonioEditar_08/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_08 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_08', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_08/:id', (req, res) => { 
    const { andar_08, patrimonio_08, empresa_08, nome_08, setor_08, descricao_08, destino_08 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_08 
            SET andar_08 = ?, Npatrimonio_08 = ?, empresa_08 = ?, nome_08 = ?, 
                setor_08 = ?, data_08 = ?, descricao_08 = ?, destino_08 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_08, patrimonio_08, empresa_08, nome_08, setor_08, data, descricao_08, destino_08, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_08 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_08], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_08, empresa_08, nome_08, setor_08, data, descricao_08, destino_08, patrimonio_08], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_08, andar_08, empresa_08, nome_08, setor_08, data, descricao_08, destino_08], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
