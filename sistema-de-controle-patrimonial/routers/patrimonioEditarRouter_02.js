...
router.get('/patrimonioEditar_02/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_02 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_02', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_02/:id', (req, res) => { 
    const { andar_02, patrimonio_02, empresa_02, nome_02, setor_02, descricao_02, destino_02 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_02 
            SET andar_02 = ?, Npatrimonio_02 = ?, empresa_02 = ?, nome_02 = ?, 
                setor_02 = ?, data_02 = ?, descricao_02 = ?, destino_02 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_02, patrimonio_02, empresa_02, nome_02, setor_02, data, descricao_02, destino_02, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_02 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_02], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_02, empresa_02, nome_02, setor_02, data, descricao_02, destino_02, patrimonio_02], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_02, andar_02, empresa_02, nome_02, setor_02, data, descricao_02, destino_02], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
