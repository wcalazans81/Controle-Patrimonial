...
router.get('/patrimonioEditar_09/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_09 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_09', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_09/:id', (req, res) => { 
    const { andar_09, patrimonio_09, empresa_09, nome_09, setor_09, descricao_09, destino_09 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_09 
            SET andar_09 = ?, Npatrimonio_09 = ?, empresa_09 = ?, nome_09 = ?, 
                setor_09 = ?, data_09 = ?, descricao_09 = ?, destino_09 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_09, patrimonio_09, empresa_09, nome_09, setor_09, data, descricao_09, destino_09, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_09 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_09], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_09, empresa_09, nome_09, setor_09, data, descricao_09, destino_09, patrimonio_09], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_09, andar_09, empresa_09, nome_09, setor_09, data, descricao_09, destino_09], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
