...
router.get('/patrimonioEditar_11/:id', (req, res) => {
    const id = req.params.id;
    const sql = 'SELECT * FROM patrimonio_11 WHERE id = ?';
    ...
    conexao.query(sql, [id], (erro, resultados) => {
        ...
        res.render('patrimonioEditar_11', { patrimonio: resultados[0] });
    });
});

router.post('/patrimonioAtualizar_11/:id', (req, res) => { 
    const { andar_11, patrimonio_11, empresa_11, nome_11, setor_11, descricao_11, destino_11 } = req.body;
    const id = req.params.id;
    ...
    conexao.beginTransaction(err => {
        ...
        const sqlUpdatePrincipal = `
            UPDATE patrimonio_11 
            SET andar_11 = ?, Npatrimonio_11 = ?, empresa_11 = ?, nome_11 = ?, 
                setor_11 = ?, data_11 = ?, descricao_11 = ?, destino_11 = ? 
            WHERE id = ?`;

        conexao.query(sqlUpdatePrincipal, [andar_11, patrimonio_11, empresa_11, nome_11, setor_11, data, descricao_11, destino_11, id], (erro1) => {
            if (erro1) {
            ...
            console.log("Tabela patrimonio_11 atualizada com sucesso.");
            ...
            conexao.query(sqlCheck, [patrimonio_11], (erroCheck, resultados) => {
                if (erroCheck) {
                    return conexao.rollback(() => {
                ...
                if (resultados.length > 0) {
                    ...
                    conexao.query(sqlUpdateRelatorio, [andar_11, empresa_11, nome_11, setor_11, data, descricao_11, destino_11, patrimonio_11], (erro2) => {
                        if (erro2) {
                            return conexao.rollback(() => {
                    ...
                    conexao.query(sqlInsertRelatorio, [patrimonio_11, andar_11, empresa_11, nome_11, setor_11, data, descricao_11, destino_11], (erroInsert) => {
                        if (erroInsert) {
                            return conexao.rollback(() => {
